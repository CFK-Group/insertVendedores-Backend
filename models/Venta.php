...
class Venta extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(Vendedor::className(), ['id' => 'id_vendedor'])->inverseOf('ventas');
    }
}
